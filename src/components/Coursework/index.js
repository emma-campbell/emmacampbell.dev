...
const Coursework = () => {
  return (
    <div className="flex-col h-screen mx-auto px-6 py-6">
      <h1 className="text-3xl font-bold">
        Relevant Courses
      </h1>
      <div className="flex h-screen items-centered justify-center">
        <div className="grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1 gap-8 pt-4 flex items-centered justify-center">
